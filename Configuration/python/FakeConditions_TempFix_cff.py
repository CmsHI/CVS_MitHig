...
cscPackingCabling.connect = 'sqlite_file:/net/pstore01/d00/scratch/yetkin/cms/CondCore/SQLiteData/data/CSCChamberMapValues_18X.db'
cscUnpackingCabling.connect = 'sqlite_file:/net/pstore01/d00/scratch/yetkin/cms/CondCore/SQLiteData/data/CSCCrateMapValues_18X.db'
