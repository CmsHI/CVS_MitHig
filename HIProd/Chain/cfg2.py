...
#process.p2 = cms.Path(process.mix*process.doAllDigi*process.L1Emulator*process.DigiToRaw)
process.p2 = cms.Path(process.mix*process.trackingParticles)
#process.p2 = cms.Path(process.pdigi*process.L1Emulator*process.DigiToRaw)
#process.outpath = cms.EndPath(process.mixTimer+process.FEVT)
