...
# SCRAM_DIR=/net/hisrv0001/home/yetkin/cms219
#
# JOB_INPUT=
# JOB_DIGI=
#
# JOB_TAG=pythia_dijet_pt100to9999_d20081021
# JOB_BASE=/net/pstore01/d00/scratch/yetkin/prod/dijet/${JOB_TAG}
#
# JOB_VERSION=219
#
# JOB_RUN_HIROOT=
...
process.MessageLogger = cms.Service("MessageLogger",
    debugModules = cms.untracked.vstring('PyquenSource'),
...
process.PyquenSource.PythiaParameters.parameterSets = cms.vstring('pythiaDefault','csa08Settings','pythiaJets','kinematics')
process.PyquenSource.PythiaParameters.kinematics = cms.vstring(
                "CKIN(3)=100",
                "CKIN(4)=9999",
                "CKIN(7)=-2.",
                "CKIN(8)=2."
