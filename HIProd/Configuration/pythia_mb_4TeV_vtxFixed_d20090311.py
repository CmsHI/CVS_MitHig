...
process.PythiaSource.comEnergy = cms.untracked.double(4000)
process.PythiaSource.PythiaParameters.pythiaDefault = cms.vstring('PMAS(5,1)=4.8 ! b quark mass',
...
process.FEVT = cms.OutputModule("PoolOutputModule",
                                fileName = cms.untracked.string('pythia_sim_mb_4TeV_vtxFixed_d20090311.root')
                                )
