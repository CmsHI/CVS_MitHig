...
# with command line options: HYDJET_MinBias_4TeV_cfi.py -s GEN:ProductionFilterSequence,SIM --conditions FrontierConditions_GlobalTag,MC_31X_V2::All --datatier GEN-SIM --eventcontent RAWSIM -n 10 --no_exec
...
process.output = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('HYDJET_MinBias_4TeV_cfi_py_GEN_SIM.root'),
