...
process.PyquenSource.PythiaParameters.parameterSets = cms.vstring('pythiaDefault','mySettings')
process.PyquenSource.PythiaParameters.mySettings = cms.vstring('CKIN(3)=0.',    #PtHatMin Lowered
...
process.FEVT = cms.OutputModule("PoolOutputModule",
                                fileName = cms.untracked.string('pyquen_off_sim_mb_4TeV_vtxFixed_d20090311.root')
                                )
