...
process.configurationMetadata = cms.untracked.PSet(
    ...
    name = cms.untracked.string('$Source: /cvs_server/repositories/CMSSW/UserCode/MitHig/HIProd/Configuration/hydjet_x2_mb_cfg.py,v $')
)
...
#            'MSTP(142) = 2',
 ...
 #           'MSTP(142)=2',    
            ...
            'PARP(149)=0.02',  
            'PARP(150)=0.085'),                 
#        decaytiming = cms.vstring('PARJ(71)=40'),        
