...
# with command line options: HYDJET_B0_Unquen_4TeV_cfi.py -s GEN:ProductionFilterSequence,SIM,DIGI,L1,DIGI2RAW --conditions FrontierConditions_GlobalTag,MC_31X_V3::All --datatier GEN-SIM-RAW --eventcontent FEVTDEBUGHLT -n 10 --no_exec
...
process.output = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('HYDJET_B0_Unquen_4TeV_cfi_py_GEN_SIM_DIGI_L1_DIGI2RAW.root'),
